...
const createImageFade = (imgPath, imgAlt) => {
    ...
    */
    ...
    let customImg = document.createElementNS('http://www.w3.org/2000/svg', 'feImage');
    ...
    */
    ...
    let imgGradient = document.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
    ...
    let imgStopEnd = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
