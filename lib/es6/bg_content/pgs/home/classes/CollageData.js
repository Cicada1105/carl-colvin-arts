class CollageData {
    ...
    static findIndex(data) {
        return CollageData.img_post_array.findIndex((currPost) => currPost.postData.header === data.header);
    }
    static isEmpty() {
        return CollageData.curr_pos === -1;
    }
    static get current_index() {
...
CollageData.curr_pos = -1;
CollageData.img_post_array = [];
