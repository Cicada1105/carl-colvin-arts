...
const loadIntroData = () => {
    let introHeaderCont = createElement({ className: 'reedmakingHeader' });
    let leftReed = createImageElement({ src: '../../resources/reedmaking_imgs/reed.png', alt: 'Reed silhouette', className: 'reed_silhouette', idName: 'leftReed' });
    let introHeader = createTextElement({ element: 'h3', text: 'Reedmaking' });
    let rightReed = createImageElement({ src: '../../resources/reedmaking_imgs/reed.png', alt: 'Reed silhouette', className: 'reed_silhouette', idName: 'rightReed' });
...
const loadTabs = () => {
    let aboutHeaderCont = createElement({ className: 'reedmakingHeader' });
    let leftReed = createImageElement({ src: '../../resources/reedmaking_imgs/reed.png', alt: 'Reed silhouette', className: 'reed_silhouette', idName: 'leftReed' });
    let aboutHeader = createTextElement({ element: 'h3', text: 'About' });
    let rightReed = createImageElement({ src: '../../resources/reedmaking_imgs/reed.png', alt: 'Reed silhouette', className: 'reed_silhouette', idName: 'rightReed' });
