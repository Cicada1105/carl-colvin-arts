...
export function init() {
    ...
    const SVG_PROPS = {
        ...
        centerX: 0,
        centerY: 0,
        strokeWidth: parseInt(window.getComputedStyle(lgCircle).strokeWidth),
        overlappedStrokeWidth: 0,
        largeRadius: lgCircle.r.baseVal.value,
        smallRadius: smCircle.r.baseVal.value,
        init: function() {
            this.centerX = this.w / 2;
            this.centerY = this.h / 2;
            this.overlappedStrokeWidth = this.strokeWidth / 2;
            this.largeRadius = this.largeRadius - this.overlappedStrokeWidth;
        }
    }*/
    //SVG_PROPS.init();
    ...
    /*let CONVERTED_SVG_PROPS = {
        centerX: SVG_PROPS.centerX * SVG_CONVERSION,
        centerY: SVG_PROPS.centerY * SVG_CONVERSION,
        strokeWidth: SVG_PROPS.strokeWidth * SVG_CONVERSION,
        overlappedStrokeWidth: SVG_PROPS.overlappedStrokeWidth * SVG_CONVERSION,
        largeRadius: SVG_PROPS.largeRadius * SVG_CONVERSION,
        smallRadius: SVG_PROPS.smallRadius * SVG_CONVERSION
    }*/
    /*OVERWRITTEN DATA*/
    let text1, text2;
    let setFillSector;
    ...
    return {
        ...
        MouseoutHandler: function (e) {
            if ((e.relatedTarget) && ((e.relatedTarget.localName === "i") || (e.relatedTarget.localName === "text"))) {
                ...
                svgCTM = svg.getCTM();
                SVG_CONVERSION = svgCTM.a;
                //distance = (Math.pow(e.offsetY - CONVERTED_SVG_PROPS.centerY,2) + Math.pow(e.offsetX - CONVERTED_SVG_PROPS.centerX,2));
                //if ((distance > Math.pow(CONVERTED_SVG_PROPS.largeRadius,2)) || (distance <= Math.pow(CONVERTED_SVG_PROPS.smallRadius,2)))
