...
const createBody = (bodyText) => {
    ...
    if (bodyText.length > 1) {
        ...
        leftArrow.addEventListener("click", () => {
            ...
            rightArrow.style.visibility = currentSlide === (bodyText.length - 1) && "visible";
        });
        ...
        rightArrow.addEventListener("click", () => {
            ...
            rightArrow.style.visibility = currentSlide === bodyText.length && "hidden";
