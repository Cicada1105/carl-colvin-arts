...
const isValidEmail = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let invalidCharMatch = (_b = recipientLocalName.match(/["(),:;<>[\]]/)) !== null && _b !== void 0 ? _b : [];
    ...
    let startingRecipientMatch = (_c = recipientLocalName.match(/(?<!\W)((?<!\w)[!#$%&'*+-/=?^_`{|}~])/g)) !== null && _c !== void 0 ? _c : [];
    ...
    let endingMatch = (_d = recipientLocalName.match(/([!#$%&'*+-/=?^_`{|}~](?!\w))(?!\W)/g)) !== null && _d !== void 0 ? _d : [];
    ...
    */
    let multiplValidChars = (_e = recipientLocalName.match(/(?<validChar>[!#$%&'*+-/=?^_`{|}~])(?=\k<validChar>)/)) !== null && _e !== void 0 ? _e : [];
    ...
    let startingDomainMatch = (_f = domain.match(/(?<!\W)((?<!\w)[.-])/g)) !== null && _f !== void 0 ? _f : [];
    ...
    let endingDomainMatch = (_g = domain.match(/([.-](?!\w))(?!\W)/g)) !== null && _g !== void 0 ? _g : [];
    ...
    let SLDName = (_h = domains[2]) !== null && _h !== void 0 ? _h : "";
    // Check for valid domain name
    let domainNameMatch = (_j = domainName.match(/[^A-Za-z0-9-]/)) !== null && _j !== void 0 ? _j : [];
