...
const createNavigation = () => {
  ...
  for (link of _data.links) {
    ...
    if (currPath.localeCompare(link.name.toLowerCase()) == 0) {
      ...
      console.log("ID = active"); // No need to continue comparing other links

      break;
    } // Store current subdirectories to loop through


    directories = link.subdirectories; // Current link could either have null subdirectories or an array of ILink objects
