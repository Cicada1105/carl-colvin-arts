    ...
    "performance": {
        ...
        body: {
            content: [
                ...
                "I have easily applied my versatility not only to genre but also to the aesthetic of " +
                    "specific performances by taking my two decades of oboe playing experience and fitting " +
                    "them into whatever ensemble requires my services. Check out the Listen page to hear " +
                    "for yourself. "
            ]
        }
    },
